...
const api = {
  ...
  claudeHistoryList: (): Promise<HistorySummary[]> => ipcRenderer.invoke(IPC.claudeHistoryList),
  claudeHistoryRead: (id: string): Promise<HistoryRecord | null> => ipcRenderer.invoke(IPC.claudeHistoryRead, id),
